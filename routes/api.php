...
Route::group(['middleware' => 'api'], function ($routeer) {
    Route::get('/users/current', [\App\Http\Controllers\UserController::class, 'get']);
    Route::put('/users/current/{id}', [\App\Http\Controllers\UserController::class, 'update']);
    ...
    Route::get('/contacts/{id}/detail', [\App\Http\Controllers\ContactController::class, 'get'])->where('id', '[0-9]+');
    Route::put('/contacts/{id}/update', [\App\Http\Controllers\ContactController::class, 'update'])->where('id', '[0-9]+');
    Route::delete('/contacts/{id}/delete', [\App\Http\Controllers\ContactController::class, 'delete'])->where('id', '[0-9]+');
